		...
		<div >
			...
			<div class=" mb-2">
				...
				<div class="row g-2 align-items-center mt-2 justify-content-between">
					<div class="col-9 col-md-4 col-lg-8 col-xl-9">
					...
					<!-- withdraw -->
					<div class="col-9 col-md-4 col-lg-8 col-xl-9" v-if="$filters.compareAddress($user.wallet.owner, $web3.account.address)">
					...
					<div class="col-3 col-md-2 col-lg-4 col-xl-3" v-if="$filters.compareAddress($user.wallet.owner, $web3.account.address)">
						<div class="d-grid gap-2">
            ...
            async withdraw() {
                await this.gCallMethod({
                    ...
                    method: async function () {
                        ...
                        const tx = await this.$web3.hub.instance.connect(this.$web3.account.signer).withdraw(this.$user.profile.id, withdrawAmount)
